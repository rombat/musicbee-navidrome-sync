...
describe('isDateAfter', function () {
  describe('dayjs object vs string comparisons', function () {
    it('should return true when dayjs date is after string date', function () {
    ...
    it('should return false when dayjs date is before string date', function () {
    ...
    it('should return false when dayjs date equals string date', function () {
  ...
  describe('string vs string comparisons', function () {
    it('should return true when first string date is after second', function () {
    ...
    it('should return false when first string date is before second', function () {
    ...
    it('should return false when string dates are equal', function () {
  ...
  describe('null and undefined handling', function () {
    it('should return false when first date is null', function () {
      const result = isDateAfter(null, '2025-01-10 09:00:00');
      expect(result).to.be.false;
    });

    it('should return false when first date is undefined', function () {
      const result = isDateAfter(undefined, '2025-01-10 09:00:00');
      expect(result).to.be.false;
    });

    it('should return true when second date is null and first is valid', function () {
      const dayjsDate = dayjs('2025-01-15 10:30:00');
      const result = isDateAfter(dayjsDate, null);
      expect(result).to.be.true;
    });

    it('should return true when second date is undefined and first is valid', function () {
      const stringDate = '2025-01-15 10:30:00';
      const result = isDateAfter(stringDate, undefined);
      expect(result).to.be.true;
    });

    it('should return false when both dates are null', function () {
      const result = isDateAfter(null, null);
      expect(result).to.be.false;
    });

    it('should return false when both dates are undefined', function () {
  ...
  describe('edge cases', function () {
    it('should handle different date formats correctly', function () {
    ...
    it('should handle milliseconds precision', function () {
    ...
    it('should handle timezone differences', function () {
    ...
    it('should return false when first date is empty string', function () {
      const result = isDateAfter('', '2025-01-10 09:00:00');
      expect(result).to.be.false;
    });

    it('should return true when second date is empty string and first is valid', function () {
      const dayjsDate = dayjs.utc('2025-01-15 10:30:00');
  ...
  describe('real-world scenarios from codebase', function () {
    it('should handle CSV date (dayjs UTC) vs database date (string) - newer CSV', function () {
    ...
    it('should handle album/artist aggregated dates (string vs string)', function () {
    ...
    it('should handle new annotations (CSV vs null database)', function () {
    ...
    it('should handle timezone differences consistently', function () {
      // CSV date in UTC
    ...
    it('should handle MusicBee CSV format vs database storage (same date)', function () {
    ...
    it('should handle MusicBee CSV format vs database storage (newer CSV)', function () {
