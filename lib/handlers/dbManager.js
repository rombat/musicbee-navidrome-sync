...
exports.init = async (options, paths) => {
  const sequelize = await createConnection(options, paths);
...
const createConnection = async (options, paths) => {
  const sequelize = new Sequelize({
    dialect: 'sqlite',
    storage: paths.dbFilePath,
